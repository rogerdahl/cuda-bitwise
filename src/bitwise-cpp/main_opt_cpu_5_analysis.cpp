...
// Stats
u64 nStatCheckedForUnderflow = 0;
u64 nStatUnderflowed = 0;
u64 nStatNotSingleResult = 0;
u64 nStatHopeless = 0;
u64 nStatNewLevel = 0;
u64 nStatEvaluated = 0;
u64 nStatValid = 0;
u64 statTotalStackItems[nSearchLevels] = {0};
...
//                #pragma omp critical
                {
                    ...
                    // Stats
                    print("\n");
                    print("nStatCheckedForUnderflow: {}\n", nStatCheckedForUnderflow);
                    print("nStatUnderflowed: {}\n", nStatUnderflowed);
                    print("nStatNotSingleResult: {}\n", nStatNotSingleResult);
                    print("nStatHopeless: {}\n", nStatHopeless);
                    print("nStatNewLevel: {}\n", nStatNewLevel);
                    print("statTotalStackItems[]:");
                    for (u32 i = 0; i < nSearchLevels; ++i) {
                        print(" {}={}", i, statTotalStackItems[i]);
                    }
                    print("\n");
                    print("nStatEvaluated: {}\n", nStatEvaluated);
                    print("nStatValid: {}\n", nStatValid);
...
//            #pragma omp atomic
            ++statTotalStackItems[nCurrentLevel - 1];
        }
        frameArr[nCurrentLevel].nStackItems = frameArr[nCurrentLevel - 1].nStackItems;
        // Run the next operation on top of the new stack.
